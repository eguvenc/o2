 ...
 * @category  Core
 * @package   Obullo
 * @author    Obullo Layered Vc Framework <obulloframework@gmail.com>
...
//     $_COOKIE['$Path'], 
//     $_COOKIE['$Domain'],
//     $_SERVER['LAYER_REQUEST']     // Layered Vc Security fix bad guys may set these variables
// );
/*
 * ------------------------------------------------------
 *  Log requests
...
$extra = array();
if ($c->load('config')['log']['benchmark']) {     // Do we need to generate benchmark data ? If so, enable and run it.

        ...
        if (empty($params['connection'])) {
            throw new RuntimeException(
                sprintf(
                    ...
                    "\$c['service provider memcached']->get(['connection' => 'default']);"
                )
            );
        }
...
// END MemcachedConnectionProvider.php class
/* End of file MemcachedConnectionProvider.php */

/* Location: .Obullo/ServiceProviders/Connections/MemcachedConnectionProvider.php */
 ...
 */
Class Password implements ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(View $view)
    {
        ...
        $element.= $this->formElement->password($data[Form::ELEMENT_NAME], $data[Form::ELEMENT_VALUE], $data[Form::ELEMENT_ATTRIBUTE]);

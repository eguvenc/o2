 ...
 */
Class Checkbox implements ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(View $view)
    {
        ...
        $element.= $this->formElement->checkbox($data[Form::ELEMENT_NAME], $data[Form::ELEMENT_VALUE], '', $data[Form::ELEMENT_ATTRIBUTE]);

...
> Maintenance katmanı uygulamanızda tanımlı olan domain adreslerine göre uygulamanızı konsoldan bakıma alma işlevlerini kontrol eder. Detaylı bilgi için [MaintenanceMiddleware.md](/Application/Docs/tr/MaintenanceMiddleware.md) dosyasını inceleyiniz.

<a name="auth"></a>

#### Auth Katmanı

> Başarılı oturum açmış ( yetkinlendirilmiş ) kullanıcılara ait katmandır. Detaylı bilgi için [AuthMiddleware.md](/Application/Docs/tr/AuthMiddleware.md) dosyasını inceleyiniz.

<a name="guest"></a>

#### Guest Katmanı

> Oturum açmamış ( yetkinlendirilmemiş ) kullanıcılara ait bir katman oluşturur. Bu katman auth paketini çağırarak kullanıcının sisteme yetkisi olup olmadığını kontrol eder ve yetkisi olmayan kullanıcıları sistem dışına yönlendirir. Genellikle route yapısında Auth katmanı ile birlikte kullanılır. Detaylı bilgi için [AuthMiddleware.md](/Application/Docs/tr/AuthMiddleware.md) dosyasını inceleyiniz.

<a name="methodNotAllowed"></a>

#### MethodNotAllowed Katmanı

> Uygulamaya gelen Http isteklerine göre metot türlerini filtrelemeyi sağlar. Belirlenen http metotları ( get, post, put, delete ) dışında bir istek gelirse isteği <kbd>HTTP Error 405 Method Not Allowed</kbd>  sayfası ile engeller. Detaylı bilgi için [MethodNotAllowedMiddleware.md](/Application/Docs/tr/MethodNotAllowedMiddleware.md) dosyasını inceleyiniz.

<a name="request"></a>

#### Request Katmanı

> Uygulamaya gelen Http isteklerinin tümünü evrensel olarak filtrelemeyi sağlayan çekirdek katmandır. Detaylı bilgi için [RequestMiddleware.md](/Application/Docs/tr/RequestMiddleware.md) dosyasını inceleyiniz.

<a name="https"></a>

#### Https Katmanı

> Uygulamada belirli adreslere gelen <kbd>http://</kbd> isteklerini <kbd>https://</kbd> protokolüne yönlendirir. Detaylı bilgi için [HttpsMiddleware.md](/Application/Docs/tr/HttpsMiddleware.md) dosyasını inceleyiniz.

<a name="translation"></a>

#### Translation Katmanı

> Uygulamaya gelen http isteklerinin tümü için <kbd>locale</kbd> anahtarlı çereze varsayılan yerel dili yada url den gönderilen dili kaydeder. Detaylı bilgi için [TranslationMiddleware.md](/Application/Docs/tr/TranslationMiddleware.md) dosyasını inceleyiniz.

<a name="rewriteLocale"></a>

#### RewriteLocale Katmanı

> Bu katman uygulamaya <kbd>http://example.com/welcome</kbd> olarak gelen istekleri mevcut yerel dili ekleyerek <kbd>http://example.com/en/welcome</kbd> adresine yönlendirir. Detaylı bilgi için [RewriteLocaleMiddleware.md](/Application/Docs/tr/RewriteLocaleMiddleware.md) dosyasını inceleyiniz.

<a name="csrf"></a>

#### Csrf Katmanı

> Csrf katmanı Cross Request Forgery güvenlik tehdidine karşı uygulamanızdaki formlarda oluşturduğunuz güvenlik algoritmasını http <kbd>POST</kbd> istekleri geldiğinde sunucu tarafında doğrular, doğrulama başarılı olmazsa katman içerisinden kullanıcı hata sayfasına yönlendirilir. Detaylı bilgi için [CsrfMiddleware.md](/Application/Docs/tr/CsrfMiddleware.md) dosyasını inceleyiniz.
